#!/home/fode4cun/.local/share/virtualenvs/checkio-ufRDicT7/bin/checkio --domain=py run sun-angle
...
def sun_angle(time):
    ...
    angle = ((int(hours) - 6) * hour_angle + (int(mins) * min_angle))
