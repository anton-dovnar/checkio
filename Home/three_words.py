#!/home/fode4cun/.local/share/virtualenvs/checkio-ufRDicT7/bin/checkio --domain=py run three-words
...
def checkio(words: str) -> bool:
    array = [True if not i.isdigit() else False for i in words.split()]
    count = 0
