#!/home/fode4cun/.local/share/virtualenvs/checkio-ufRDicT7/bin/checkio --domain=py run morse-decoder
...
def morse_decoder(code):
    ...
    for w in words:
        word = ''.join([MORSE[l] for l in w.split(' ')])
        decoded_words.append(word)

    text = ' '.join(decoded_words)
    return text.capitalize() if text[0].isalpha() else text
