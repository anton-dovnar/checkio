#!/home/fode4cun/.local/share/virtualenvs/checkio-ufRDicT7/bin/checkio --domain=py run cipher-dict-decryption

# In this mission, you have to convert a data encryped by get_cipher(cipher dict)to a original text.
# 
# Input:A cipher data as a dict.
# 
# Output:A original text as a string.
# 
